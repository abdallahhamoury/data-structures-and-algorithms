...
const addExclamation = (arr) => {
  let newArrExclamation = [];
  arr.forEach((item) => {
    newArrExclamation.push(`${item}!`);

  }
  )
  return newArrExclamation;
};
...
const allUpperCase = (arr) => {
  let newArrUpperCase = [];
  arr.forEach((item) =>{
    newArrUpperCase.push(item.toUpperCase());
  }

  )
  return newArrUpperCase
};
