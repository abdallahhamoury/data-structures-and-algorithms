...
E.g. [4,2,7,5,9,2] -> 9
------------------------------------------------------------------------------------------------ */
const maxInArray = (arr) => { return arr.reduce((ele, ind) => Math.max(ele, ind)); };
...
const checkValues = (obj, value) => {
  ...
  let newArr = Object.values(obj).includes(value);
...
const getHouses = (arr) => {
  ...
  Object.values(arr).map(ite=> houses.push(ite.house)  );
